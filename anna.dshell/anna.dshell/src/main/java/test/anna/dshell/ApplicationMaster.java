  ...
  private class LaunchContainerRunnable implements Runnable {
    ...
    public void run() {
      ...
      if (!scriptPath.isEmpty()) {
        ...
        LocalResource shellRsrc = LocalResource.newInstance(yarnUrl,LocalResourceType.FILE, LocalResourceVisibility.APPLICATION,
      ...
      for (String com:commands){
    	  LOG.info("RIZ>> Launcing command: " + com);
      }
